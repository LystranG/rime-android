...
| 18 键（主题自带，功能键盘 hint「18键」） | **薄荷全拼 rime_mint** | 万象官方同款 8 组合并（W E→w、R T→r、I O→i、S D→s、F G→f、J K→j、X C→x、B N→b），映射在 `rime_mint.custom.yaml` |
| 小鹤 18 键（本包新增，功能键盘 hint「鹤18」） | **小鹤双拼 double_pinyin_flypy** | 四叶草分组拆开 B/N（8 组），与 17 键共用映射；`你好 = BN IO H C` 四键直出 |
| 17 键（本包新增） | **小鹤双拼 double_pinyin_flypy** | 四叶草 9 组合并（QW/ER/TY/OP/AS/DF/JK/ZX/BN） |
...
2. 长按回车 → 功能键盘 → 17键/鹤18 按钮出现且能切换，键盘样式与主题一致（圆角图片键）；
